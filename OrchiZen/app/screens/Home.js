  ...
  const orchidData = [
    {
      name: "Dendrobium",
      description:
        "A hardy orchid known for its vibrant blooms, Dendrobium thrives in bright, indirect light with moderate watering.",
      image: require("../assets/images/dendrobium.jpg"), // Replace with your orchid images
    },
    {
      name: "Vanda",
      description:
        "Vanda orchids produce striking, long-lasting flowers and require high humidity, strong light, and frequent watering.",
      image: require("../assets/images/Vanda.png"), // Replace with your orchid images
    },
    {
      name: "Phalaenopsis",
      description:
        "Also called the 'moth orchid,' Phalaenopsis is easy to grow, preferring low light and consistent moisture.",
      image: require("../assets/images/Phalaenopsis.png"), // Replace with your orchid images
    },
  ];
